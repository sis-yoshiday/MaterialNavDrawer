...
public class DrawerArrowDrawable extends Drawable {
  ...
  public static final String PARAMETER = DrawerArrowDrawable.class.getCanonicalName() + ".parameter";
  ...
  public void onSaveInstanceState(Bundle outState) {
    outState.putFloat(PARAMETER, parameter);
  }

  public void restoreState(@NonNull Bundle savedInstanceState) {
    parameter = savedInstanceState.getFloat(PARAMETER, 0.f);
  }
}